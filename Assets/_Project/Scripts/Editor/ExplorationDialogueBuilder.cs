...
public static class ExplorationDialogueBuilder
{
    ...
    public static void Build()
    {
        ...
        {
            L("Итак.", 1.5f),
            L("Ты находишься в чужом доме.", 2.5f),
            L("Никто тебя не звал.", 2f),
        };
        ...
        a[1].lines = new[]
        {
            ...
            L("Просто оказываешься и смотришь.", 2f),
            L("Ничего не трогаешь.", 2f),
        };
        ...
        a[4].lines = new[]
        {
            L("На балконе Мэри.", 1.5f),
            L("По документу сильная, со своим мнением.", 3f),
        };
        ...
        a[7].lines = new[]
        {
            ...
            L("Что за история узнаешь позже.", 2.5f),
        ...
        a[10].lines = new[]
        {
            ...
            L("Просто говорить, пока ты ходишь.", 2f),
        ...
        {
            L("Также...", 1f),
            L("Если ты поиграешь во второй раз.", 1.5f),
        ...
        a[14].lines = new[]
        {
            L("Хочешь знать, зачем ты здесь?", 2f),
        ...
        a[16].lines = new[]
        {
            ...
            L("Иногда достаточно просто побыть в каком-нибудь месте.", 3.5f),
            L("Не в той реальности в которой находишься.", 3.5f),
        ...
        a[18].lines = new[]
        {
            ...
            L("Не знаю, смогу ли я тебя ещё долго развлекать.", 3f),
        ...
        a[21].lines = new[]
        {
            L("По его истечению с тобой ничего не случится.", 3.5f),
            ...
            L("Так что не пытайся, смысла нет.", 2f),
        };

        // Сегмент 22 — таймер скучен, появляется кликер
        a[22].lines = new[]
        {
            L("Ладно. Похоже, таймер тебя не впечатлил.", 3f),
        ...
        a[27].lines = new[]
        {
            ...
            L("Шаг. Шаг. Шаг.", 1f),
            L("Ты, собственно, этим и занимаешься.", 2f),
        };
        ...
        a[32].lines = new[]
        {
            L("Знаешь, в чём прелесть простых кликеров?", 3f),
            L("Они честны.", 1.5f),
            L("Вот ты кликаешь, и видишь, что происходит.", 3f),
        };
        ...
        a[37].lines = new[]
        {
            ...
            L("Не знаю.", 2f),
            L("Ведь я не настоящий, только тебе дано понять.", 3f),
            L("Возможно поэтому ты здесь.", 2f),
            L("Только тебе дано оценить...", 1.5f),
        ...
        a[41].lines = new[]
        {
            L("Помоги жильцам разобраться с этой непростой проблемой.", 4f, "QuestCanvas"),
        };
        ...
        var trigA = CreateSeq(folder, "Seq_Trigger_A", 10, null,
            L("Стой!", 1.5f),
            L("Присмотрись...", 2f),
            L("На лестничной клетке посмотри вниз.", 2f),
        ...
        var trigB = CreateSeq(folder, "Seq_Trigger_B", 10, null,
            L("Поздравляю!", 1.5f),
            L("Ты нашёл секретный лаз Разработчика.", 2f),
            ...
            L("Ну, почти нет...", 2f),
            L("Ты же решаешь, куда идти.", 2f),
            L("Но серенад и концовок всё равно не будет.", 2f),
            L("Вместо этого, за эту находку...", 2f),
            L("Разработчик награждает тебя...", 3f),
            L("Скучным видом из окна.", 2f, "SecretBlock"),
            L("А ты можешь называть себя тестировщиком игры.", 2f),
            L("Но, похоже, Мэри расстроена.", 2f),
            L("У неё больше нет красивого вида...", 2f),
            L("На HDRI карту.", 2f),
            L("И это — дело твоих рук.", 2f),
            L("Знаешь, иногда есть вещи, которые...", 2f),
            L("Лучше не трогать.", 2f),
            L("В любом случае, твоя наблюдательность", 2f),
            L("Разработчика явно радует.", 2f),
            L("Ладно. Ты меня прервал своими выходками.", 2f),
            L("Возвращаемся.", 1f)
        );
