...
public static class QuestDialogueBuilder
{
    ...
    public static void Build()
    {
        ...
        var reject2 = CreateSeq(folder, "QuestReject_2", 5, null,
            L("Порядок 1234. Просто попробуй.", 2f));
        ...
        var reject4 = CreateSeq(folder, "QuestReject_4", 5, null,
            L("Ладно.", 1.5f),
            L("Я надеялся, что твои умственные способности выше...", 3f),
            L("Ладно. Я выполню задание за тебя.", 3f),
            L("Смотри внимательно.", 2f));
        ...
        var postQuest = CreateSeq(folder, "QuestDone_PostQuest", 5, null,
            L("Похоже, ты выполнил квест.", 2.5f),
            L("И сломал картины...", 2.5f),
            L("Но, ты заработал 1000 опыта.", 2.5f),
            L("Однако, тебе некуда его тратить...", 3f),
            L("Хм, я кое что нашел.", 1f),
        ...
        var xpBar = CreateSeq(folder, "QuestDone_XPBar", 5, null,
            L("Теперь начислим тебе опыт...", 3f));

        // seqLevelUp — после AutoLevelUp
        var levelUp = CreateSeq(folder, "QuestDone_LevelUp", 5, null,
            L("Отлично, ты повысил уровень!", 1.5f),
            L("Давай посмотрим...", 1f),
        ...
        var abilityChosen = CreateSeq(folder, "QuestDone_AbilityChosen", 5, null,
            ...
            L("Делай выбор очень внимательно.", 3f),
            L("Ты не сможешь откатить изменения.", 3f));
        ...
        var doorEpilogue = CreateSeq(folder, "QuestDone_DoorEpilogue", 5, null,
            L("Смотри, дверь пропала.", 3.5f),
            L("Ты можешь идти.", 2.5f),
            L("Если спрыгнешь вниз, ты перейдешь дальше.", 2.5f),
            L("Но я тебя торопить не буду.", 3f),
            L("Можешь находится здесь сколько хочешь...", 3f),
        ...
        var doorUnlocked = CreateSeq(folder, "QuestDone_DoorUnlocked", 5, doorEpilogue,
            L("Кстати, тебе открылся переход...", 3f),
