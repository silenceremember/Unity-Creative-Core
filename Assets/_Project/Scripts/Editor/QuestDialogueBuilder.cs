...
public static class QuestDialogueBuilder
{
    ...
    public static void Build()
    {
        ...
        var reject0 = CreateSeq(folder, "QuestReject_0", 5, null,
            L("Рассказчик", "Похоже, картины надо нажать в правильном порядке.", 3.5f));

        // Reject 2
        var reject1 = CreateSeq(folder, "QuestReject_1", 5, null,
            L("Рассказчик", "Похоже, картины нужно нажать в порядке 1234.", 1.5f));

        // Reject 3
        var reject2 = CreateSeq(folder, "QuestReject_2", 5, null,
            L("Рассказчик", "Порядок 1234. Просто попробуй.", 2f));

        // Reject 4
        var reject3 = CreateSeq(folder, "QuestReject_3", 5, null,
            L("Рассказчик", "Я начинаю сомневаться в эффективности подсказок.", 1.5f));

        // Reject 5 — рассказчик решает сам
        var reject4 = CreateSeq(folder, "QuestReject_4", 5, null,
            L("Рассказчик", "Ладно.", 1.5f),
            L("Рассказчик", "Я надеялся, что твои умственные способности выше...", 3f),
            L("Рассказчик", "Ладно. Я выполню задание за тебя.", 3f),
            L("Рассказчик", "Смотри внимательно.", 2f));
        ...
        var xpBar = CreateSeq(folder, "QuestDone_XPBar", 5, null,
            L("Рассказчик", "Теперь начислим тебе опыт...", 3f));

        // seqLevelUp — после AutoLevelUp
        var levelUp = CreateSeq(folder, "QuestDone_LevelUp", 5, null,
            L("Рассказчик", "Отлично, ты повысил уровень!", 1.5f),
            L("Рассказчик", "Давай посмотрим...", 1f),
        ...
        var doorEpilogue = CreateSeq(folder, "QuestDone_DoorEpilogue", 5, null,
            ...
            L("Рассказчик", "Если спрыгнешь вниз, ты перейдешь дальше.", 2.5f),
