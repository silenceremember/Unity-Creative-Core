...
public static class QuestDialogueBuilder
{
    ...
    public static void Build()
    {
        ...
        var reject1 = CreateSeq(folder, "QuestReject_1", 5, null,
            L("Рассказчик", "Похоже, картины нужно нажать в порядке:", 1.5f),
            L("Рассказчик", "1, 2, 3, 4.", 3f));

        // Reject 3
        var reject2 = CreateSeq(folder, "QuestReject_2", 5, null,
            L("Рассказчик", "Ладно.", 1f),
            L("Рассказчик", "Порядок — 1, 2, 3, 4.", 2f),
            L("Рассказчик", "Просто попробуй.", 2f));

        // Reject 4
        var reject3 = CreateSeq(folder, "QuestReject_3", 5, null,
            L("Рассказчик", "Я начинаю сомневаться...", 1.5f),
            L("Рассказчик", "В эффективности устных подсказок.", 3f));
        ...
        var levelUp = CreateSeq(folder, "QuestDone_LevelUp", 5, null,
            L("Рассказчик", "Отлично, ты повысил уровень!", 2.5f),
