...
public static class NovelDialogueBuilder
{
    ...
    public static void Build()
    {
        ...
        {
            new object[] { Speaker.John, "I'm standing by the door because...", "Я стою у двери, потому что...", CameraAnchor.John, seqIntroJohn },
            new object[] { Speaker.John, "...because it feels right here.", "...потому что мне здесь хорошо.", CameraAnchor.John, null },
            new object[] { Speaker.John, "I sense skepticism.", "Слышу скепсис.", CameraAnchor.John, seqNarrDisagrees },
            new object[] { Speaker.Mary, "It's beautiful here.", "Красиво здесь.", CameraAnchor.Mary, seqIntroMary },
            new object[] { Speaker.John, "Mary.", "Мэри.", CameraAnchor.John, null },
            new object[] { Speaker.Mary, "What.", "Что.", CameraAnchor.Mary, null },
            new object[] { Speaker.John, "There's someone in the living room.", "В гостиной кто-то есть.", CameraAnchor.John, null },
            new object[] { Speaker.Mary, "Are you sure?", "Ты уверен?", CameraAnchor.Mary, null },
            new object[] { Speaker.John, "I... I can feel it. Someone's there.", "Я... чувствую. Там кто-то есть.", CameraAnchor.John, null },
            ...
            new object[] { Speaker.John, "I didn't call a repairman.", "Я не вызывал мастера.", CameraAnchor.John, null },
            new object[] { Speaker.Mary, "I did.", "Я вызывала.", CameraAnchor.Mary, null },
            new object[] { Speaker.John, "When?", "Когда?", CameraAnchor.John, null },
            new object[] { Speaker.Mary, "I don't remember.", "Не помню.", CameraAnchor.Mary, null },
            new object[] { Speaker.John, "Hey. Who are you?", "Эй. Ты кто?", CameraAnchor.JohnClose, seqAfterNotRemember },
            new object[] { Speaker.Player, "...", "...", CameraAnchor.Player, null },
            new object[] { Speaker.John, "Do you know how to fix TVs?", "Ты умеешь чинить телевизоры?", CameraAnchor.JohnClose, seqAfterPlayerSilence },
            new object[] { Speaker.Player, "...", "...", CameraAnchor.Player, null },
            new object[] { Speaker.John, "Perhaps that's a sign of agreement.", "Возможно, это знак согласия.", CameraAnchor.JohnClose, null },
            new object[] { Speaker.John, "And how does this work?", "И как это работает?", CameraAnchor.John, seqJohnNarr1 },
            new object[] { Speaker.John, "I'm standing.", "Я стою.", CameraAnchor.John, seqJohnNarr2 },
            new object[] { Speaker.John, "I'm standing and talking.", "Я стою и разговариваю.", CameraAnchor.John, seqJohnNarr3 },
            new object[] { Speaker.John, "I'm incredibly multifunctional.", "Я невероятно многофункциональный.", CameraAnchor.John, null },
            ...
            new object[] { Speaker.John, "I don't know.", "Не знаю.", CameraAnchor.John, null },
