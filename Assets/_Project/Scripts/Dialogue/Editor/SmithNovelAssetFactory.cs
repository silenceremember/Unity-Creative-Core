...
public class SmithNovelAssetFactory : EditorWindow
{
    ...
    public static void CreateAssets()
    {
        ...
        novelSeq.lines = new NovelLine[]
        {
            ...
            new NovelLine { speaker = "Джон",     text = "Я... чувствую. Там кто-то есть.",   cameraIndex = 0, narratorSequenceBefore = seqAfterFeeling },
            ...
            new NovelLine { speaker = "Джон",     text = "Это было неприятно.",                cameraIndex = 0 },
