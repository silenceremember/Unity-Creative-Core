...
public class SmithNovelAssetFactory : EditorWindow
{
    ...
    public static void CreateAssets()
    {
        ...
        // Рассказчик вводит игрока — после «Я... чувствую. Там кто-то есть.»
        ...
        // Реакция на «Я... чувствую.» — Джон видит игрока через четвёртую стену
        var seqAfterFeeling = MakeSeq(folder, "Narr_AfterFeeling",
            ("Рассказчик", "Он не чувствует в привычном смысле.", 0.3f),
            ("Рассказчик", "Просто написано, что чувствует.", 0.7f)
        );
        ...
        var seqAfterNotRemember = MakeSeq(folder, "Narr_AfterNotRemember",
            ...
            ("Рассказчик", "Воспоминаний до этой сцены у неё нет.", 0.3f),
        ...
        var seqEnding = MakeSeq(folder, "Narr_Ending",
            ...
            ("Рассказчик", "Вы, впрочем — тоже.", 0.5f),
            ("Рассказчик", "В любом случае.", 0.4f),
            ("Рассказчик", "Вы только что прошли через визуальную новеллу.", 0.4f),
            ("Рассказчик", "Разработчик считает, что это, как правило, скучно.", 0.4f),
            ("Рассказчик", "Сидеть. Читать. Нажимать «Далее».", 0.4f),
            ("Рассказчик", "Не очень-то захватывает.", 0.5f),
            ("Рассказчик", "Поэтому он разблокировал для вас:", 0.4f),
            ("Рассказчик", "Ходьбу.", 1.1f),
            ("Рассказчик", "WASD. Или стики. На ваш выбор.", 0.4f),
        ...
        novelSeq.lines = new NovelLine[]
        {
            ...
            // ── БЛОК 4: РАССКАЗЧИК ВВОДИТ ИГРОКА — после «Я чувствую» ──────────
            new NovelLine { speaker = "Player 1", text = "...",                                 cameraIndex = 3, narratorSequenceBefore = seqIntroYou },
            // Рассказчик: «Он не чувствует в привычном смысле...»
            new NovelLine { speaker = "Джон",     text = "Это было неприятно.",                cameraIndex = 0, narratorSequenceBefore = seqAfterFeeling },
